...
powers = [
    ...
    {name:"super human senses", description: "allows the person to use their sense at super human level"},
    {name:"elasticity", description: "can stretch human body to extreme lengths"}
]
...
heroes = [
    ...
    {name:"Bruce Barner", super_name:"Hulk"},
    ...
    {name:"Thor Odison", super_name:"Thor"},
